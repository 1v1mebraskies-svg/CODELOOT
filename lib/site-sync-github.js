 ...
 */
import { createOrUpdateFile, deleteFile } from './github-api.js';
 ...
 * @returns {Promise<{ files: string[], removed: string[] }>}
 */
export async function syncGamePagesToGithub(gamesData) {
...
/**
 * Remove game page files from GitHub when games are deleted from JSON.
 * @param {string[]} slugs
 */
export async function removeGamePagesFromGithub(slugs) {
  const removed = [];
